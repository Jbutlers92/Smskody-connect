...
const MY_DOMAIN = 'https://resplendent-forgiveness-production-aaae.up.railway.app'; // ← change this if needed
    ...
    credentials: [
      {
        name: "apiKey",
        label: "API Key",
        description: "Not required (key is on the connector)",
        required: false
      }
    ],
    tempApi: {
